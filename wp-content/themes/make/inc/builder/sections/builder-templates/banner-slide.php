...
$video 		        = ( isset( $ttfmake_section_data['data']['banner-slides'][ $ttfmake_slide_id ]['video'] ) ) ? $ttfmake_section_data['data']['banner-slides'][ $ttfmake_slide_id ]['video'] : 'none';
...
<?php endif; ?>
	...
	$inputs = apply_filters( 'make_banner_slide_configuration', array(
		...
		300 => array(
			'type'    => 'checkbox',
			'label'   => __( 'Darkenen background to improve readability', 'make' ),
			'name'    => 'darken',
			'default' => 0
		),
		400 => array(
