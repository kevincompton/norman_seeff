...
= 1.7.5 - December 9 2016 =
* Bug fix: Some templates were being parsed with default templateSettings, breaking functionality of the builder.
...
= 1.7.5 =
Hot-fix which removes a breaking bug in builder Javascript templating.
